...
def get_gpu(name: str) -> GPUSpec:
    """Return the GPUSpec for ``name``; raises UnknownSpecError listing available names."""
...
def get_llm(name: str) -> LLMSpec:
    """Return the LLMSpec for ``name``; raises UnknownSpecError listing available names."""
